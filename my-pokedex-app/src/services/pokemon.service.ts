...
export class PokemonService {
  ...
  getTrainerPokemons(trainerId: string) {
    return this.pokemons.filter((pokemon) => pokemon.trainer === trainerId);
  }

  addPokemon(pokemonData: NewPokemonData, trainerId: string) {
